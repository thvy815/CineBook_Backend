...
namespace BookingService.API.Controllers
{
    ...
    public class BookingSeatController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<BookingSeatDTOs>>> GetAll()
        {
        ...
        [HttpGet("{id:guid}")]
        public async Task<ActionResult<BookingSeatDTOs>> GetById(Guid id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Create([FromBody] BookingSeatDTOs dto)
        {
        ...
        [HttpPut("{id:guid}")]
        public async Task<ActionResult> Update(Guid id, [FromBody] BookingSeatDTOs dto)
        {
            if (id != dto.Id)
